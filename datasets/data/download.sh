wget --keep-session-cookies --save-cookies=cookies.txt --post-data 'username=zzhu@graimatterlabs.ai&password=13816221366&submit=Login' https://www.cityscapes-dataset.com/login/
